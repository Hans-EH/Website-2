...
const Greeting = (props) => {
    return (
        <body style={{marginBottom: "10%"}}>
            ...
            <div class="fade-in3">
            <h2 style={{paddingLeft: '1%'}}>I'm a data enthusiast; cryptology lover; aspiring machine learning engineer. Currently working as an <a href="#experience"><span> student IT security analyst </span></a> at Januar</h2>
            </div>
        </body>
    )
}
